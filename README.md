...
**All code generated by Manus AI, Gemini 3 Pro, Claude Opus 4.5, Claude Opus 4.6, Gemini 3.1 Pro, ChatGPT 5.2-Codex**


## PR conflict troubleshooting

If GitHub still shows conflicts for this branch after local conflict resolution, run:

```bash
./push_work.sh
```

This force-pushes the rebased `work` branch tip (`--force-with-lease`) so GitHub reflects the latest resolved state.
