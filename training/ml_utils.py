"""Shared utilities for validation, vocabulary, compression, and evaluation."""
...
def build_vocab(texts: Iterable[str], max_vocab_size: int, min_token_count: int) -> Dict[str, int]:
...
def compress_model(model: "MediumModel", keep_threshold: float = -12.0, ndigits: int = 5) -> "MediumModel":
    ...
    return model.__class__(compressed_priors, compressed_probs)
